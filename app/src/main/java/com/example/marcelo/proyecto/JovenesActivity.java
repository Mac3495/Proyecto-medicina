...
public class JovenesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent(getApplicationContext(),Remedios2Activity.class);
        ...
        Enfermedades enfermedades_datos [] = new Enfermedades[]{
                ...
                new Enfermedades(R.drawable.en2,"LOS DOLORES ESTOMACALES"),
                ...
                new Enfermedades(R.drawable.en4,"ENFERMEDADES DE LA VISTA"),
        ...
        listView = (ListView) findViewById(R.id.list_view_jovenes);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        intent.putExtra("dato2",6);
                        break;
                    case 7:
                        intent.putExtra("dato2",7);
                        break;
                }
